export const ActionCatalog = {
  ...
  EffectsMenuHydrate: 'effects/menu/hydrate',
  EffectsMenuSave: 'effects/menu/save',
  ...
  MenuHydrate: 'menu/hydrate',
  MenuReorderItems: 'menu/reorderItems',
  MenuUpdateConfig: 'menu/updateConfig',
