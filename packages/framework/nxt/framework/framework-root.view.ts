...
import { configureFrameworkAuth, onFrameworkAuthStateChange } from './firebase-auth.utils';
import { firestorePersistence } from './firestore-persistence.utils';
import { HandlerAction, ReducerHandler, createHandlerRegistry, coreHandlers } from '../registries/handler.registry';
import { hybridPersistence } from './hybrid-persistence.utils';
import { getFrameworkLogger } from '../helpers/logger.utils';
import { setFirestoreSyncCallback } from './persistence.utils';
import { registerFrameworkEffects } from '../registries/effects.registry';
import { validateState } from '../context/state-validator.state';
import { UIState } from '../types/state.types';
import { uiState, UiStateContextState } from '../context/ui.state';
import { viewRegistry } from '../registries/view.registry';
import { FrameworkContextState, registerWorkspaceHandlers } from '../workspace/workspace-registry.handlers';
