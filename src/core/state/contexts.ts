...
import { PanelStateContext, UiCombinedContext, UiDispatchContext } from './ui-state';
...
export const uiStateContext = UiCombinedContext;
export const uiDispatchContext = UiDispatchContext;
export const panelStateContext = PanelStateContext;
